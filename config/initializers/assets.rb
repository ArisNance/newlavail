...
Rails.application.config.assets.precompile += %w( jquery.simplyscroll.css )
Rails.application.config.assets.precompile += %w( bootstrap.min.css )
Rails.application.config.assets.precompile += %w( instaslide.css )
Rails.application.config.assets.precompile += %w( animations.css )
Rails.application.config.assets.precompile += %w( tidy.css )
...
Rails.application.config.assets.precompile += %w( jquery.simplyscroll.js )
